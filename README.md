...
python script/pre_n3d.py --video_path <location>/<scene>
```
...
```
conda activate colmapenv
python script/pre_n3d.py --video_path /home/Neural3D/cook_spinach/
```
...
```
conda activate colmapenv
python script/pre_technicolor.py --video_path <location>/<scene>
```
...
```
python test.py --quiet --eval --skip_train --val_loader colmap_valid --config_path config/n3d_<lite|full>/<scene>.json --model_path <path to model> --source_path <location>/<scene>/colmap_0
```

- Test model on Technicolor Dataset
```
python test.py --quiet --eval --skip_train --val_loader technicolor_valid --config_path config/techni_<lite|full>/<scene>.json --model_path <path to model> --source_path <location>/<scenename>/colmap_0
```
